...
import Border from '@/assets/border-horizontal.svg?react'
...
export const Horizontal: FC<Props> = ({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 p-64 bg-cover bg-no-repeat rotate-90 text-black"
        style={{
          width: '2970px',
          height: '2100px',
